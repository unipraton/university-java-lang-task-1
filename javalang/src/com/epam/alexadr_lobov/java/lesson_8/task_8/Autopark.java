package com.epam.alexadr_lobov.java.lesson_8.task_8;

import com.epam.alexadr_lobov.java.lesson_8.task_8.utilities.ArrayUtility;
import com.epam.alexadr_lobov.java.lesson_8.task_8.utilities.CarConnector;
import com.epam.alexadr_lobov.java.lesson_8.task_8.vehicles.Car;
import com.epam.alexadr_lobov.java.lesson_8.task_8.vehicles.Sellable;
...
public class Autopark {
    ...
    private void run() {
        ...
        try {
            ...
            CarConnector connector = new CarConnector("resources/cars.xml");
